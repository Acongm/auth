...
test('auth exposes a green 聪 icon via Next app metadata files', () => {
  ...
  assert.equal(existsSync('apps/auth/app/favicon.ico'), true);
  assert.equal(existsSync('apps/auth/app/icon.png'), true);
  assert.equal(existsSync('apps/auth/public/favicon.ico'), true);
  assert.equal(existsSync('apps/auth/public/icon.png'), true);
  assert.deepEqual(readIcoOpaqueRgb('apps/auth/app/favicon.ico'), GREEN);
  assert.deepEqual(readIcoOpaqueRgb('apps/auth/public/favicon.ico'), GREEN);
  assert.deepEqual(readPngOpaqueRgb('apps/auth/app/icon.png'), GREEN);
  assert.deepEqual(readPngOpaqueRgb('apps/auth/public/icon.png'), GREEN);
});
